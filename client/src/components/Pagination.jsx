    ...
    for (
      ...
      buttons.push(
        <button
          ...
          className={`hidden sm:inline px-3 py-1 mx-1 rounded-full border font-[Inter] text-xs ${
  ...
  return (
    <div className="flex justify-center items-center mt-4">
      <button
        ...
        className={`px-3 py-1 mx-2 rounded-full border border-blue-500 text-blue-500 hover:bg-blue-400 hover:text-white transition duration-300 ease-in-out font-[Inter] font-medium text-xs flex items-center ${
